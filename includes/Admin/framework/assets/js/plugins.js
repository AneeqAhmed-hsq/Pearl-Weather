...
(function() {
  var $, SPLWTAbstractChosenOrder, _ref,
    ...
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent.prototype[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
(function($) {
  $(document).ready(function() {
    ...
    $('.pw-chosen-select').each(function() {
      var $this = $(this);
      var is_ajax = $this.data('chosen-ajax') || false;
      ...
      if (is_multiple) {
        ...
        $this.on('change', function(obj, result) {
          ...
          if (typeof window.wp.customize !== 'undefined') {
            // customizer sync code can be added here
          }
        });
    ...
    $('.splwt-lite-fields').splwt_dependency();
  });
})(jQuery);